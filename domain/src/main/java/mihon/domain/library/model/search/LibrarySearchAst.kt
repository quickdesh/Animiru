...
enum class AnimeField(vararg val aliases: String, val fieldOnly: Boolean = false) {
    TITLE("title"),
    AUTHOR("author"),
    ARTIST("artist"),
    ...
    companion object {
        ...
        fun fromString(value: String): AnimeField? = lookup[value.lowercase()]
    }
}
...
data class FieldQueryNode(val field: AnimeField, val value: String, val negated: Boolean) : QueryNode
