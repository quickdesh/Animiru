...
data class TrackInfoDialogHomeScreen(
    ...
    override fun Content() {
        ...
        val viewModel = assistedMetroViewModel<Model, Model.Factory> {
            create(animeId = animeId, sourceId = sourceId, isSeason = isSeason)
        }
    ...
    class Model(
        ...
        // AM -->
        @Assisted private val isSeason: Boolean,
        // <-- AM
        ...
        interface Factory : ManualViewModelAssistedFactory {
            fun create(animeId: Long, sourceId: Long, isSeason: Boolean): Model
        }
...
data class TrackEpisodeSelectorScreen(
    private val track: Track,
    private val serviceId: Long,
) : Screen() {
...
data class TrackerRemoveScreen(
    ...
    override fun Content() {
        val navigator = LocalNavigator.currentOrThrow
        val viewModel = assistedMetroViewModel<Model, Model.Factory> {
            create(animeId = animeId, track = track, trackerId = serviceId)
        }
                ...
                Row(
                    ...
                    FilledTonalButton(
                        onClick = {
                            ...
                            if (removeRemoteTrack) viewModel.deleteAnimeFromService()
                            navigator.pop()
                        },
                        colors = ButtonDefaults.filledTonalButtonColors(
                            containerColor = MaterialTheme.colorScheme.errorContainer,
    ...
    class Model(
        ...
        @ContributesIntoMap(AppScope::class)
        interface Factory : ManualViewModelAssistedFactory {
            fun create(animeId: Long, track: Track, trackerId: Long): Model
        }
